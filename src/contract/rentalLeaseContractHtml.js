...
<div class="contract-page">
  ...
  <p class="mb1"> &nbsp; &nbsp; 3. Cọc: ………………………..</p>
  <p class="mb1"> &nbsp; &nbsp; 4. Thời hạn thuê: từ <strong>${fromHour}:00 ngày ${fromDate}</strong> đến <strong>${toHour}:00 ngày ${toDate}</strong>.</p>
  <p class="mb1"> &nbsp; &nbsp; 5. Địa điểm giao/nhận tài sản: ${deliveryPlaceText}.</p>
  <p class="mb1"> &nbsp; &nbsp; 6. Giá trị từng tài sản ghi tại khoản 1 do Bên A xác định và Bên B xác nhận khi ký biên bản bàn giao; đây là căn cứ để xác định nghĩa vụ bồi thường, các khoản phạt và chi phí liên quan theo Hợp đồng, không phụ thuộc định giá thị trường, giá chào bán hoặc mua lại, mức khấu hao hay kết quả thẩm định độc lập khác, trừ khi hai bên lập văn bản sửa đổi Hợp đồng.</p>
  <p class="mb1 mt1"><strong>ĐIỀU 2: THANH TOÁN, CỌC VÀ XÁC MINH ĐỊNH DANH</strong></p>
  ...
  <p class="mb1"> &nbsp; &nbsp; 2. Bên B đặt cọc cho Bên A tại thời điểm nhận tài sản, bằng tiền hoặc tài sản thế chân theo thỏa thuận, với mức hoặc nội dung cọc ghi tại Điều 1 khoản 3. Bên A hoàn trả cọc cho Bên B không muộn hơn sáu (06) giờ kể từ thời điểm Bên B hoàn trả tài sản. Trước khi hoàn cọc, Bên A được khấu trừ các khoản Bên B còn phải thanh toán theo Hợp đồng (tiền thuê còn lại, bồi thường, phạt vi phạm, phí phát sinh, nếu có) và hoàn phần còn lại trong cùng thời hạn. Việc hoàn cọc không làm mất quyền của Bên A yêu cầu bồi thường, phạt và chi phí theo Điều 4 nếu phát hiện hư hỏng hoặc thiếu sót khi kiểm tra.</p>
  <p class="mb1"> &nbsp; &nbsp; 3. <strong>Hai bên không thỏa thuận áp dụng lãi chậm thanh toán theo Hợp đồng này.</strong> Khi Bên B chậm thanh toán hoặc chậm thực hiện nghĩa vụ tiền, Bên A được <strong>yêu cầu thanh toán ngay</strong> toàn bộ khoản còn phải trả và được <strong>áp dụng biện pháp thu hồi tài sản, khởi kiện, yêu cầu áp dụng biện pháp khẩn cấp</strong> hoặc biện pháp khác <strong>theo quy định pháp luật</strong>.</p>
